...
#define TRICE_UART USART1 //!< Enable and set UART for serial output.
...
#define TRICE_BUFFER_INFO                                                                  \
    do                                                                                     \
    {                                                                                      \
        TRICE32(Id(41052), "att: Trice 2x half buffer size:%4u ", TRICE_HALF_BUFFER_SIZE); \
    } while (0)
#else
#define TRICE_BUFFER_INFO                                                                                     \
    do                                                                                                        \
    {                                                                                                         \
        TRICE32(Id(37130), "att:Single Trice Stack buf size:%4u", TRICE_SINGLE_MAX_SIZE + TRICE_DATA_OFFSET); \
    } while (0)
#endif
